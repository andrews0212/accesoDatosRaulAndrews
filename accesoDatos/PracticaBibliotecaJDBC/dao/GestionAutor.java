...
public class GestionAutor implements DAO{
	...
	public GestionAutor(Connection conexion) {
		metaDatos = new metaDatos(conexion, "Autor");
		...
		for (String registro : registros) {
			...
			if (datos.isEmpty()) {
				...
				registroObjetos.add(Autor.objetoArray(datos));
			}
		}
	}
	...
	public void actualizarMemoria(Connection conexion) {
		this.registroObjetos = new GestionAutor(conexion).getRegistroObjetos();
	}
	...
	public boolean insertar(Connection conexion, ArrayList<String> datos) {
		...
		Autor objeto = Autor.objetoArray(datos);
